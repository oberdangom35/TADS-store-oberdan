...
function MeusEnderecos({ busca, setBusca, categoria, setCategoria, categorias, buscaAberta, setBuscaAberta }) {
      ...
      <main className="minha-conta-page">
        ...
        <div className="minha-conta-content">
          <aside className="conta-menu">
            ...
            <Link to="/meus-enderecos" className="conta-menu-item ativo">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <Link to="/meus-pedidos" className="conta-menu-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              {usuario?.address ? (
                <div className="conta-dados-grid">
                  <div className="conta-campo">
                    ...
                    <p>{usuario.address.address || 'Não informado'}</p>
                  </div>
                  <div className="conta-campo">
                    <label>Cidade</label>
                    <p>{usuario.address.city || 'Não informado'}</p>
                  </div>
                  <div className="conta-campo">
                    <label>Estado</label>
                    <p>{usuario.address.state || 'Não informado'}</p>
                  </div>
                  <div className="conta-campo">
                    <label>CEP</label>
                    <p>{usuario.address.postalCode || 'Não informado'}</p>
                  </div>
                </div>
              ) : (
